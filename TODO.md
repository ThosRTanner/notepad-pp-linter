...
1)
* include error level (probably mostly useless)
...
* don't keep reopening clipboard (maybe)
* implement next and last lint menu items
* take clipboard class into sep file.
...
* use cmd=command args=string-with-{param}
  ...
  * {param} param may be
    ...
    * dirpath - directory of original file (not somewhere in tmpdir)
